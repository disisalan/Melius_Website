    ...
    <div className="bg-black font-inter px-6 lg:px-24 text-white">
      ...
      <div className="py-5 md:py-10 overflow-x-auto text-xs md:text-2xl flex flex-nowrap gap-5 md:gap-10">
        ...
        <div className="p-3 md:p-5 relative bg-grey/25 rounded-xl bg-contain w-[200px] h-[266px] md:w-[400px] md:h-[533px] flex-none">
          ...
          <img src="../Media/bg-1.png" alt="" className="rounded-md h-[150px] w-[200px] md:w-[400px] md:h-[300px]" />
          
          {/* Project Text Info */}
          <div className="py-2 md:py-4">
            <h1 className="font-poppins font-bold text-base md:text-3xl">Project Name Here</h1>
            <h1 className="font-light">Project Description Here</h1>
          </div>

          {/* Buttons at bottom */}
          <div className="absolute right-2 md:right-4 bottom-2 md:bottom-4 z-5">
            <button className="py-1 px-3 font-bold bg-blue rounded-xl md:rounded-3xl">More Details</button>
          </div>
        </div>
        <div className="p-3 md:p-5 relative bg-grey/25 rounded-xl bg-contain w-[200px] h-[266px] md:w-[400px] md:h-[533px] flex-none">
