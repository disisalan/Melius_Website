...
export default function EventDetail(){
    ...
    <div className="bg-black font-inter px-6  lg:px-24 text-white">
        <div className="p-5">
        <h1 className="py-5  text-blue text-3xl font-poppins lg:text-5xl font-bold"> Event Heading</h1>
        <div className="lg:flex gap-8 font-inter">
            <img src="../Media/bg-1.png" alt="" className="rounded-3xl"/>
