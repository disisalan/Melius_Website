...
export default function EventDetail(event) {
    ...
    return (
        <div className="bg-black font-inter px-6  lg:px-24 text-white">
            <div className="p-5">
                <h1 className="py-5  text-White text-3xl font-poppins border-b-2 border-blue lg:text-5xl font-bold">
                    {" "}
                    Event Heading
                </h1>
                    ...
                    <div className="text-lg">
                        <div className=" mb-10 lg:mb-16    ">
                            ...
                            <p className="">
                                ...
                                adipisicing elit. Est perspiciatis beatae
                                veritatis dicta soluta sit ipsum aut enim.
                                Quibusdam voluptatum doloremque placeat at saepe
                                beatae et ut pariatur maiores velit?
                            </p>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <span> 20th Octber , 2023</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <p className="text-xl font-poppins font-semibold text-blue">
                                Venue :{" "}
                            </p>
                            <span>MSI Auditorium</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <p className="text-xl font-poppins font-semibold text-blue">
                                Mode :{" "}
